...
/*
  ...
  as input, and outputs the correct CSS-in-JS
  object to define CSS variables

  We're expecting an output like so:

  '--primary-50': getRgbChannels('#eef2ff'),
...
module.exports = plugin(
  function ({ addBase }) {
    /*
      ------------------------------
      2. Use the `getCssVariableDeclarations` helper to
      replace the hardcoded CSS variables below.
      ------------------------------
    */
    addBase({
